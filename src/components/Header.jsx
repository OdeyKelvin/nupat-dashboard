...
export default function Header() {
  ...
  return (
    <div >
      <div ref={sidemenuContainer} className='duration-300 hidden md:block'>
        <Sidebar />
      </div>
      <div className=' flex flex-col  xl:w-[1345px] xl:h-[220px]'>

        <div className=' relative ml-[400px] top-32 md:hidden '><AiOutlineMenu size={23} onClick={Handlenav} /></div>
        ...
        <div className='members xl:mb-6 '>
          ...
          <div className=' relative -top-[40px] text-[#B8B9BD]  font-normal text-[14px] ml-[110px] mt-9 xl:top-[0px] xl:ml-[400px] xl:mt-[9px]'>8 memebers</div>
        </div>
