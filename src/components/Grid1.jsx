...
export default function Grid1() {
  return (
    ...
    <div className='grid1 relative mb-4'> 
                 ...
                 <div className=' absolute bg-white  rounded-xl p-4 w-[410px] left-[30px] h-[350px] top-[330px] xl:w-[270px] xl:left-[290px] xl:top-[300px] '> 
                     ...
                     <div className=' text-gray '>
                      ...
                      <span className=' text-md font-semibold ml-auto text-black '> 2
                       ...
                       <div className=' mt-8 ml-1'>7</div>             
                          ...
                          <div className=' absolute bg-white  rounded-xl p-4 w-[400px] left-[8px] h-[200px] -bottom-[240px] xl:w-[270px] xl:left-[1px] xl:top-[370px]'>
